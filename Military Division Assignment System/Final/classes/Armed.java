...
public class Armed extends Soldier implements Comando,SSF
{
	...
	public Armed(String name, int age, String ID, int joiningyear , int bts, int longcourse, String Brigade, String Regiment)
